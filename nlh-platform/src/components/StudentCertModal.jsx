...
import { toWAPhone, logOutbound, waMsgId, WA_BODIES } from '../services/whatsapp'
...
export default function StudentCertModal({ student, enrollments, centre, onClose }) {
  ...
  async function handleWhatsApp() {
    ...
    try {
      ...
      await sb.from('enrollments')
        .update({ cert_wa_sent_at: new Date().toISOString(), cert_wa_message_id: waMsgId(data), cert_wa_status: 'sent' })
      ...
      logOutbound(waTo, WA_BODIES.certIssued({
        studentName: student.full_name || 'Student',
        parentName:  student.parent_name || 'Parent',
        courseName:  courseLabel || 'the course',
      }), 'image', waMsgId(data), data.certUrl || null)
      setWaSent(true)
