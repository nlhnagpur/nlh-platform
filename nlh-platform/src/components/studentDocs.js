...
export function printFranchiseeAgreement(franchisee, agreement, ctx) {
  ...
  const body = `
    ...
    <div class="sigblock">
      <div class="sigcell">
        <img src="/DRP%20Signature.png" alt="Signature" style="height:36px;object-fit:contain;display:block;margin-top:4px">
        <div class="line" style="margin-top:6px"><div class="name">Dhiral Panchmatia</div><div class="role">Proprietor, New Learning Horizons</div></div>
